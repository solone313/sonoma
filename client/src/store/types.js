...
export const GET_RECIEPTS_LOADING = "GET_RECIEPTS_LOADING";
export const GET_RECIEPTS_SUCCESS = "GET_RECIEPTS_SUCCESS";
export const GET_RECIEPTS_FAIL = "GET_RECIEPTS_FAIL";

export const GET_RECIEPT_LOADING = "GET_RECIEPT_LOADING";
export const GET_RECIEPT_SUCCESS = "GET_RECIEPT_SUCCESS";
export const GET_RECIEPT_FAIL = "GET_RECIEPT_FAIL";

export const ADD_RECIEPT_LOADING = "ADD_RECIEPT_LOADING";
export const ADD_RECIEPT_SUCCESS = "ADD_RECIEPT_SUCCESS";
export const ADD_RECIEPT_FAIL = "ADD_RECIEPT_FAIL";

export const DELETE_RECIEPT_LOADING = "DELETE_RECIEPT_LOADING";
export const DELETE_RECIEPT_SUCCESS = "DELETE_RECIEPT_SUCCESS";
export const DELETE_RECIEPT_FAIL = "DELETE_RECIEPT_FAIL";

export const EDIT_RECIEPT_LOADING = "EDIT_RECIEPT_LOADING";
export const EDIT_RECIEPT_SUCCESS = "EDIT_RECIEPT_SUCCESS";
export const EDIT_RECIEPT_FAIL = "EDIT_RECIEPT_FAIL";

export const CLEAR_RECIEPT_ERROR = "CLEAR_RECIEPT_ERROR";